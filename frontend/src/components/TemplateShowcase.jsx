...
const templates = [
  { id: 1, name: 'Online Stores', type: 'E-Commerce', color: '#10b981', desc: 'Boost sales with a premium shopping experience.', image: '/templates/premium_ecommerce_template.png' },
  ...
  { id: 3, name: 'Luxury Dining', type: 'Food & Dining', color: '#f59e0b', desc: 'Savor the digital flavor with elegant menus.', image: '/templates/premium_restaurant_template.png' },
  ...
  { id: 5, name: 'Digital Marketing', type: 'Agency', color: '#3b82f6', desc: 'Accelerate growth with a modern marketing agency dashboard.', image: '/templates/digital_marketing_template.png' },
