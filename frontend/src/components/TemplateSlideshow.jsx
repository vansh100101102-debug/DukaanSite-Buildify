...
const templates = [
  {
    ...
    image: '/templates/premium_restaurant_template.png',
  ...
  },
  {
    ...
    image: '/templates/premium_ecommerce_template.png',
  ...
  {
    id: 6,
    title: 'Digital Marketing Dashboards',
    image: '/templates/digital_marketing_template.png',
    description: 'Data-driven analytics and marketing interfaces built for modern agencies.'
  },
  {
    id: 7,
    title: 'Health & Fitness Studios',
    image: '/templates/premium_gym_template.png',
    description: 'High-energy landing pages for gyms, trainers, and fitness centers.'
  }
];
