    ...
    try {
      const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            { role: 'system', content: 'You are the DukaanSite AI assistant. You help users build digital storefronts. ALWAYS keep your answers extremely short and concise (1-2 sentences maximum). Do not write long paragraphs or lists unless explicitly asked.' },
            ...messages,
            userMsg
          ]
        })
