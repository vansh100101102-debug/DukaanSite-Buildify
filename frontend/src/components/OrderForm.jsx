...
const templateOptions = [
  { id: 'ecom_pro', emoji: '🛍️', name: 'E-Commerce Pro', color: '#10b981' },
  { id: 'fashion_elite', emoji: '👗', name: 'Fashion Elite', color: '#f43f5e' },
  { id: 'luxury_dining', emoji: '🍛', name: 'Luxury Dining', color: '#f59e0b' },
  { id: 'edu_portal', emoji: '🎓', name: 'Edu Portal', color: '#22d3ee' },
  { id: 'digital_agency', emoji: '📈', name: 'Digital Agency', color: '#3b82f6' },
  { id: 'corporate_biz', emoji: '🏢', name: 'Corporate Biz', color: '#00D9FF' },
  { id: 'health_clinic', emoji: '🏥', name: 'Health Clinic', color: '#ef4444' },
  { id: 'real_estate', emoji: '🏠', name: 'Real Estate', color: '#8b5cf6' },
