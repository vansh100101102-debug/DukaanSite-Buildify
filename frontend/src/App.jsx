...
import InteractiveParticleRing from './components/InteractiveParticleRing'
...
function App() {
  ...
  useEffect(() => {
    const handleMouseMove = (e) => {
      ...
      btn.style.transform = `translate(${x * 0.3}px, ${y * 0.3}px) scale(1.05) perspective(400px) rotateX(${-y * 0.1}deg) rotateY(${x * 0.1}deg)`;
    };
    
    const handleMouseLeave = (e) => {
      const btn = e.currentTarget;
      btn.style.transform = `translate(0px, 0px) scale(1) rotateX(0deg) rotateY(0deg)`;
    };
