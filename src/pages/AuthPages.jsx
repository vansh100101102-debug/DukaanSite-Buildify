      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-16 overflow-hidden">
        ...
        >
          <div className="flex items-center gap-3 mb-12">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple to-cyan flex items-center justify-center font-black text-white italic">S</div>
            <span className="text-2xl font-black tracking-tighter">ShopForge</span>
          </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    required
                    className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-4 focus:outline-none focus:border-cyan focus:bg-white/10 transition-all font-medium"
                    placeholder="jane@shopforge.com"
                    value={email}
